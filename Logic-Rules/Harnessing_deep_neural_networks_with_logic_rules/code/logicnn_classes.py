...
class LeNetConvPoolLayer(object):
    ...
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(2, 2), non_linear="tanh"):
        ...
        if self.non_linear=="tanh":
            ...
            self.output = pool.pool_2d(input=conv_out_tanh, ds=self.poolsize, ignore_border=True, mode='max')
    ...
    def predict(self, new_data, batch_size):
        ...
        if self.non_linear=="tanh":
            ...
            output = pool.pool_2d(input=conv_out_tanh, ds=self.poolsize, ignore_border=True, mode='max')
